...
public abstract class StringUtils {
    ...
    /**
     * Parse the given {@code localeString} value into a
    ...
    public static String[] concatenateStringArrays(String[] array1,
                                                   String[] array2) {
        if (ObjectUtils.isEmptyArray(array1)) {
            return array2;
        }
        if (ObjectUtils.isEmptyArray(array2)) {
            return array1;
        }
	...
	/*public static String getRealPath(String imagePath) {
        if (imagePath != null && !imagePath.equals("")) {
			imagePath = ResConfig.getRealPath(imagePath);
		}
		return imagePath;
	}*/

    public static String changNull(String s) {
        if (s == null) {
            s = "";
        }
        return s;
    ...
    public static StringBuffer removeLastComma(StringBuffer sb) {

        StringBuffer stringBuf = new StringBuffer();
        String s = new String(sb);
        if (sb.length() > 0) {
            int postion = sb.lastIndexOf(",");

            if (postion == sb.length() - 1) {
                s = s.substring(0, postion);
            }
        }
     ...
     * @return
     */
    public static String handlePrivinceName(String province) {
        if (province == null || province.equals("")) {
            province = "广东省";
        } else {
            if (!province.contains("区")) {
    ...
    public static String handleCityName(String city) {
    ...
    public static String removeDomain(String str) {
        Pattern pattern = Pattern
                .compile(
                        "(http://((25[0-5])|(2[0-4]\\d)|(1\\d\\d)|([1-9]\\d)|\\d)(\\.((25[0-5])|(2[0-4]\\d)|(1\\d\\d)|([1-9]\\d)|\\d)){3}(\\:\\d{1,})?/)|(http://[a-zA-Z0-9][-a-zA-Z0-9]{0,62}(\\.[a-zA-Z0-9][-a-zA-Z0-9]{0,62})+\\.?(\\:\\d{1,})?)/",
